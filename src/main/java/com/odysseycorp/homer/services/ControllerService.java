...
public class ControllerService {
    ...
    public void updateController(String id, Controller updatedController){
        ...
        if(updatedController.getIp() != null) oldController.setIp(updatedController.getIp());
        if(updatedController.getName() != null) oldController.setName(updatedController.getName());
